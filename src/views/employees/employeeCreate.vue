...
<template>
    ...
    <div class="w-12 md:w-10 m-auto p-2 md:p-5 branches">
        <h1 class="p-4 text-center textColor">تسجيل موظف جديد</h1>
        ...
        <div v-if="isBranchesFetched && isRolesFetched">
            <FormKit type="form" :actions="false" @submit="createEmployee">
                ...
                <div class="mt-3 col-12">
                    ...
                    <div class="mt-3 col-12 md:col-6">
                        ...
                        <FormKit prefix-icon="email" id="mail" type="email" label="البريد الالكتروني" placeholder="أدخل البريد الالكتروني" name="email" validation="email" />
                    </div>
                    <div class="mt-3 col-12 md:col-6">
                        <div class="flex align-items-center">
